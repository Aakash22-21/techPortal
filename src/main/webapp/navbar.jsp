...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<!-- Profile pic Start --> <c:if
						test="${not empty sessionScope.userobj}">
						<div class="media">

							<img src="profile_img/<%=Helper.getUserProffileImg(session)%>"
								height="35px" width="50px" alt="User Default img">
							<div class="media-body">

								<a class="nav-link" href="#">
									${sessionScopeuserobj.userFname}</a>
